sidebar <- dashboardSidebar(collapsed = T,uiOutput("sidebarpanel"),
                            conditionalPanel('input.tabs == c("1","2","3","4","5")',selectizeInput('yearnum', 'Which year', choices = c('All', `Years` = list(tot_test2$year))),
